...
public class TRoomCategoryResponse implements org.apache.thrift.TBase<TRoomCategoryResponse, TRoomCategoryResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TRoomCategoryResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TRoomCategoryResponse");

  private static final org.apache.thrift.protocol.TField ROOM_CATEGORY_FIELD_DESC = new org.apache.thrift.protocol.TField("roomCategory", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TRoomCategoryResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TRoomCategoryResponseTupleSchemeFactory();

  private TRoomCategory roomCategory; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.ROOM_CATEGORY, new org.apache.thrift.meta_data.FieldMetaData("roomCategory", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TRoomCategory.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TRoomCategoryResponse.class, metaDataMap);
  }

  public TRoomCategoryResponse() {
  }

  public TRoomCategoryResponse(
    TRoomCategory roomCategory,
    TStatus status,
   ...
   */
  public TRoomCategoryResponse(TRoomCategoryResponse other) {
    if (other.isSetRoomCategory()) {
      this.roomCategory = new TRoomCategory(other.roomCategory);
    }
  ...
  public TRoomCategoryResponse deepCopy() {
    return new TRoomCategoryResponse(this);
  }
  ...
  public TRoomCategory getRoomCategory() {
    return this.roomCategory;
  }

  public void setRoomCategory(TRoomCategory roomCategory) {
    this.roomCategory = roomCategory;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ROOM_CATEGORY:
      if (value == null) {
        ...
        setRoomCategory((TRoomCategory)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TRoomCategoryResponse)
      return this.equals((TRoomCategoryResponse)that);
    return false;
  }

  public boolean equals(TRoomCategoryResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TRoomCategoryResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TRoomCategoryResponse(");
    boolean first = true;
  ...
  private static class TRoomCategoryResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRoomCategoryResponseStandardScheme getScheme() {
      return new TRoomCategoryResponseStandardScheme();
    }
  }

  private static class TRoomCategoryResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TRoomCategoryResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TRoomCategoryResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // ROOM_CATEGORY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.roomCategory = new TRoomCategory();
              struct.roomCategory.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map200.size);
                java.lang.String _key201;
                java.lang.String _val202;
                for (int _i203 = 0; _i203 < _map200.size; ++_i203)
                {
                  _key201 = iprot.readString();
                  _val202 = iprot.readString();
                  struct.errorList.put(_key201, _val202);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRoomCategoryResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.roomCategory != null) {
        oprot.writeFieldBegin(ROOM_CATEGORY_FIELD_DESC);
        struct.roomCategory.write(oprot);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter204 : struct.errorList.entrySet())
          {
  ...
  private static class TRoomCategoryResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRoomCategoryResponseTupleScheme getScheme() {
      return new TRoomCategoryResponseTupleScheme();
    }
  }

  private static class TRoomCategoryResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRoomCategoryResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TRoomCategoryResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter205 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TRoomCategoryResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map206.size);
          java.lang.String _key207;
          java.lang.String _val208;
          for (int _i209 = 0; _i209 < _map206.size; ++_i209)
          {
            _key207 = iprot.readString();
            _val208 = iprot.readString();
            struct.errorList.put(_key207, _val208);
          }
        }
        struct.setErrorListIsSet(true);
      }
