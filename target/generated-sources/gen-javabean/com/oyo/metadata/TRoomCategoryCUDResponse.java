...
public class TRoomCategoryCUDResponse implements org.apache.thrift.TBase<TRoomCategoryCUDResponse, TRoomCategoryCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TRoomCategoryCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TRoomCategoryCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TRoomCategoryCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TRoomCategoryCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TRoomCategoryCUDResponse.class, metaDataMap);
  }

  public TRoomCategoryCUDResponse() {
  }
   ...
   */
  public TRoomCategoryCUDResponse(TRoomCategoryCUDResponse other) {
  ...
  public TRoomCategoryCUDResponse deepCopy() {
    return new TRoomCategoryCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TRoomCategoryCUDResponse)
      return this.equals((TRoomCategoryCUDResponse)that);
    return false;
  }

  public boolean equals(TRoomCategoryCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TRoomCategoryCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TRoomCategoryCUDResponse(");
    boolean first = true;
  ...
  private static class TRoomCategoryCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRoomCategoryCUDResponseStandardScheme getScheme() {
      return new TRoomCategoryCUDResponseStandardScheme();
    }
  }

  private static class TRoomCategoryCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TRoomCategoryCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TRoomCategoryCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map210.size);
                java.lang.String _key211;
                java.lang.String _val212;
                for (int _i213 = 0; _i213 < _map210.size; ++_i213)
                {
                  _key211 = iprot.readString();
                  _val212 = iprot.readString();
                  struct.errorList.put(_key211, _val212);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRoomCategoryCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter214 : struct.errorList.entrySet())
          {
  ...
  private static class TRoomCategoryCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRoomCategoryCUDResponseTupleScheme getScheme() {
      return new TRoomCategoryCUDResponseTupleScheme();
    }
  }

  private static class TRoomCategoryCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRoomCategoryCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TRoomCategoryCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter215 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TRoomCategoryCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map216.size);
          ...
          for (int _i219 = 0; _i219 < _map216.size; ++_i219)
          {
            ...
            struct.errorList.put(_key217, _val218);
          }
        }
        struct.setErrorListIsSet(true);
      }
