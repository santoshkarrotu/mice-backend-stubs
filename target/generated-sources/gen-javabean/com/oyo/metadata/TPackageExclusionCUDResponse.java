...
public class TPackageExclusionCUDResponse implements org.apache.thrift.TBase<TPackageExclusionCUDResponse, TPackageExclusionCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TPackageExclusionCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPackageExclusionCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPackageExclusionCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPackageExclusionCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPackageExclusionCUDResponse.class, metaDataMap);
  }

  public TPackageExclusionCUDResponse() {
  }
   ...
   */
  public TPackageExclusionCUDResponse(TPackageExclusionCUDResponse other) {
  ...
  public TPackageExclusionCUDResponse deepCopy() {
    return new TPackageExclusionCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPackageExclusionCUDResponse)
      return this.equals((TPackageExclusionCUDResponse)that);
    return false;
  }

  public boolean equals(TPackageExclusionCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPackageExclusionCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPackageExclusionCUDResponse(");
    boolean first = true;
  ...
  private static class TPackageExclusionCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPackageExclusionCUDResponseStandardScheme getScheme() {
      return new TPackageExclusionCUDResponseStandardScheme();
    }
  }

  private static class TPackageExclusionCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPackageExclusionCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPackageExclusionCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map130.size);
                ...
                for (int _i133 = 0; _i133 < _map130.size; ++_i133)
                {
                  ...
                  struct.errorList.put(_key131, _val132);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPackageExclusionCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter134 : struct.errorList.entrySet())
          {
  ...
  private static class TPackageExclusionCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPackageExclusionCUDResponseTupleScheme getScheme() {
      return new TPackageExclusionCUDResponseTupleScheme();
    }
  }

  private static class TPackageExclusionCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPackageExclusionCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPackageExclusionCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter135 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPackageExclusionCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map136.size);
          ...
          for (int _i139 = 0; _i139 < _map136.size; ++_i139)
          {
            ...
            struct.errorList.put(_key137, _val138);
          }
        }
        struct.setErrorListIsSet(true);
      }
