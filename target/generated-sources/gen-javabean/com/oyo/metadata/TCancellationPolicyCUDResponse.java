...
public class TCancellationPolicyCUDResponse implements org.apache.thrift.TBase<TCancellationPolicyCUDResponse, TCancellationPolicyCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TCancellationPolicyCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TCancellationPolicyCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TCancellationPolicyCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TCancellationPolicyCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCancellationPolicyCUDResponse.class, metaDataMap);
  }

  public TCancellationPolicyCUDResponse() {
  }
   ...
   */
  public TCancellationPolicyCUDResponse(TCancellationPolicyCUDResponse other) {
  ...
  public TCancellationPolicyCUDResponse deepCopy() {
    return new TCancellationPolicyCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TCancellationPolicyCUDResponse)
      return this.equals((TCancellationPolicyCUDResponse)that);
    return false;
  }

  public boolean equals(TCancellationPolicyCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TCancellationPolicyCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TCancellationPolicyCUDResponse(");
    boolean first = true;
  ...
  private static class TCancellationPolicyCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCancellationPolicyCUDResponseStandardScheme getScheme() {
      return new TCancellationPolicyCUDResponseStandardScheme();
    }
  }

  private static class TCancellationPolicyCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCancellationPolicyCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TCancellationPolicyCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map350.size);
                java.lang.String _key351;
                java.lang.String _val352;
                for (int _i353 = 0; _i353 < _map350.size; ++_i353)
                {
                  _key351 = iprot.readString();
                  _val352 = iprot.readString();
                  struct.errorList.put(_key351, _val352);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCancellationPolicyCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter354 : struct.errorList.entrySet())
          {
  ...
  private static class TCancellationPolicyCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCancellationPolicyCUDResponseTupleScheme getScheme() {
      return new TCancellationPolicyCUDResponseTupleScheme();
    }
  }

  private static class TCancellationPolicyCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCancellationPolicyCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCancellationPolicyCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter355 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCancellationPolicyCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map356.size);
          java.lang.String _key357;
          java.lang.String _val358;
          for (int _i359 = 0; _i359 < _map356.size; ++_i359)
          {
            _key357 = iprot.readString();
            _val358 = iprot.readString();
            struct.errorList.put(_key357, _val358);
          }
        }
        struct.setErrorListIsSet(true);
      }
