            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map180.size);
                ...
                for (int _i183 = 0; _i183 < _map180.size; ++_i183)
                {
                  ...
                  struct.errorList.put(_key181, _val182);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, THotelCategoryResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter184 : struct.errorList.entrySet())
          {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter185 : struct.errorList.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map186.size);
          ...
          for (int _i189 = 0; _i189 < _map186.size; ++_i189)
          {
            ...
            struct.errorList.put(_key187, _val188);
          }
        }
        struct.setErrorListIsSet(true);
      }
