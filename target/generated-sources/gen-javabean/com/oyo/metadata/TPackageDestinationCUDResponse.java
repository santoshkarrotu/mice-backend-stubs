...
public class TPackageDestinationCUDResponse implements org.apache.thrift.TBase<TPackageDestinationCUDResponse, TPackageDestinationCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TPackageDestinationCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPackageDestinationCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPackageDestinationCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPackageDestinationCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPackageDestinationCUDResponse.class, metaDataMap);
  }

  public TPackageDestinationCUDResponse() {
  }
   ...
   */
  public TPackageDestinationCUDResponse(TPackageDestinationCUDResponse other) {
  ...
  public TPackageDestinationCUDResponse deepCopy() {
    return new TPackageDestinationCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPackageDestinationCUDResponse)
      return this.equals((TPackageDestinationCUDResponse)that);
    return false;
  }

  public boolean equals(TPackageDestinationCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPackageDestinationCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPackageDestinationCUDResponse(");
    boolean first = true;
  ...
  private static class TPackageDestinationCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPackageDestinationCUDResponseStandardScheme getScheme() {
      return new TPackageDestinationCUDResponseStandardScheme();
    }
  }

  private static class TPackageDestinationCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPackageDestinationCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPackageDestinationCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map30.size);
                ...
                for (int _i33 = 0; _i33 < _map30.size; ++_i33)
                {
                  ...
                  struct.errorList.put(_key31, _val32);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPackageDestinationCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter34 : struct.errorList.entrySet())
          {
  ...
  private static class TPackageDestinationCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPackageDestinationCUDResponseTupleScheme getScheme() {
      return new TPackageDestinationCUDResponseTupleScheme();
    }
  }

  private static class TPackageDestinationCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPackageDestinationCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPackageDestinationCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter35 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPackageDestinationCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map36.size);
          ...
          for (int _i39 = 0; _i39 < _map36.size; ++_i39)
          {
            ...
            struct.errorList.put(_key37, _val38);
          }
        }
        struct.setErrorListIsSet(true);
      }
