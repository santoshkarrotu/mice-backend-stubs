...
public class TMiceEventCUDResponse implements org.apache.thrift.TBase<TMiceEventCUDResponse, TMiceEventCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TMiceEventCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TMiceEventCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TMiceEventCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TMiceEventCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TMiceEventCUDResponse.class, metaDataMap);
  }

  public TMiceEventCUDResponse() {
  }
   ...
   */
  public TMiceEventCUDResponse(TMiceEventCUDResponse other) {
  ...
  public TMiceEventCUDResponse deepCopy() {
    return new TMiceEventCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TMiceEventCUDResponse)
      return this.equals((TMiceEventCUDResponse)that);
    return false;
  }

  public boolean equals(TMiceEventCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TMiceEventCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TMiceEventCUDResponse(");
    boolean first = true;
  ...
  private static class TMiceEventCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TMiceEventCUDResponseStandardScheme getScheme() {
      return new TMiceEventCUDResponseStandardScheme();
    }
  }

  private static class TMiceEventCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TMiceEventCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TMiceEventCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map270.size);
                ...
                for (int _i273 = 0; _i273 < _map270.size; ++_i273)
                {
                  ...
                  struct.errorList.put(_key271, _val272);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMiceEventCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter274 : struct.errorList.entrySet())
          {
  ...
  private static class TMiceEventCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TMiceEventCUDResponseTupleScheme getScheme() {
      return new TMiceEventCUDResponseTupleScheme();
    }
  }

  private static class TMiceEventCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMiceEventCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TMiceEventCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter275 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TMiceEventCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map276.size);
          java.lang.String _key277;
          java.lang.String _val278;
          for (int _i279 = 0; _i279 < _map276.size; ++_i279)
          {
            _key277 = iprot.readString();
            _val278 = iprot.readString();
            struct.errorList.put(_key277, _val278);
          }
        }
        struct.setErrorListIsSet(true);
      }
