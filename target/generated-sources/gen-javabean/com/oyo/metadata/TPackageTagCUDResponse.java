...
public class TPackageTagCUDResponse implements org.apache.thrift.TBase<TPackageTagCUDResponse, TPackageTagCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TPackageTagCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPackageTagCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPackageTagCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPackageTagCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPackageTagCUDResponse.class, metaDataMap);
  }

  public TPackageTagCUDResponse() {
  }
   ...
   */
  public TPackageTagCUDResponse(TPackageTagCUDResponse other) {
  ...
  public TPackageTagCUDResponse deepCopy() {
    return new TPackageTagCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPackageTagCUDResponse)
      return this.equals((TPackageTagCUDResponse)that);
    return false;
  }

  public boolean equals(TPackageTagCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPackageTagCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPackageTagCUDResponse(");
    boolean first = true;
  ...
  private static class TPackageTagCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPackageTagCUDResponseStandardScheme getScheme() {
      return new TPackageTagCUDResponseStandardScheme();
    }
  }

  private static class TPackageTagCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPackageTagCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPackageTagCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map230.size);
                ...
                for (int _i233 = 0; _i233 < _map230.size; ++_i233)
                {
                  ...
                  struct.errorList.put(_key231, _val232);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPackageTagCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter234 : struct.errorList.entrySet())
          {
  ...
  private static class TPackageTagCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPackageTagCUDResponseTupleScheme getScheme() {
      return new TPackageTagCUDResponseTupleScheme();
    }
  }

  private static class TPackageTagCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPackageTagCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPackageTagCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter235 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPackageTagCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map236.size);
          ...
          for (int _i239 = 0; _i239 < _map236.size; ++_i239)
          {
            ...
            struct.errorList.put(_key237, _val238);
          }
        }
        struct.setErrorListIsSet(true);
      }
