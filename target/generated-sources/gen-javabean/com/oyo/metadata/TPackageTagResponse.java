...
public class TPackageTagResponse implements org.apache.thrift.TBase<TPackageTagResponse, TPackageTagResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TPackageTagResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPackageTagResponse");

  private static final org.apache.thrift.protocol.TField PACKAGE_TAG_FIELD_DESC = new org.apache.thrift.protocol.TField("packageTag", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPackageTagResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPackageTagResponseTupleSchemeFactory();

  private TPackageTag packageTag; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.PACKAGE_TAG, new org.apache.thrift.meta_data.FieldMetaData("packageTag", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TPackageTag.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPackageTagResponse.class, metaDataMap);
  }

  public TPackageTagResponse() {
  }

  public TPackageTagResponse(
    TPackageTag packageTag,
    TStatus status,
   ...
   */
  public TPackageTagResponse(TPackageTagResponse other) {
    if (other.isSetPackageTag()) {
      this.packageTag = new TPackageTag(other.packageTag);
    }
  ...
  public TPackageTagResponse deepCopy() {
    return new TPackageTagResponse(this);
  }
  ...
  public TPackageTag getPackageTag() {
    return this.packageTag;
  }

  public void setPackageTag(TPackageTag packageTag) {
    this.packageTag = packageTag;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PACKAGE_TAG:
      if (value == null) {
        ...
        setPackageTag((TPackageTag)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPackageTagResponse)
      return this.equals((TPackageTagResponse)that);
    return false;
  }

  public boolean equals(TPackageTagResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPackageTagResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPackageTagResponse(");
    boolean first = true;
  ...
  private static class TPackageTagResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPackageTagResponseStandardScheme getScheme() {
      return new TPackageTagResponseStandardScheme();
    }
  }

  private static class TPackageTagResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPackageTagResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPackageTagResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // PACKAGE_TAG
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.packageTag = new TPackageTag();
              struct.packageTag.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map220.size);
                ...
                for (int _i223 = 0; _i223 < _map220.size; ++_i223)
                {
                  ...
                  struct.errorList.put(_key221, _val222);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPackageTagResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.packageTag != null) {
        oprot.writeFieldBegin(PACKAGE_TAG_FIELD_DESC);
        struct.packageTag.write(oprot);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter224 : struct.errorList.entrySet())
          {
  ...
  private static class TPackageTagResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPackageTagResponseTupleScheme getScheme() {
      return new TPackageTagResponseTupleScheme();
    }
  }

  private static class TPackageTagResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPackageTagResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPackageTagResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter225 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPackageTagResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map226.size);
          ...
          for (int _i229 = 0; _i229 < _map226.size; ++_i229)
          {
            ...
            struct.errorList.put(_key227, _val228);
          }
        }
        struct.setErrorListIsSet(true);
      }
