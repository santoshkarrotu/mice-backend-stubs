...
public class TPaymentPolicyCUDResponse implements org.apache.thrift.TBase<TPaymentPolicyCUDResponse, TPaymentPolicyCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TPaymentPolicyCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPaymentPolicyCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPaymentPolicyCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPaymentPolicyCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPaymentPolicyCUDResponse.class, metaDataMap);
  }

  public TPaymentPolicyCUDResponse() {
  }
   ...
   */
  public TPaymentPolicyCUDResponse(TPaymentPolicyCUDResponse other) {
  ...
  public TPaymentPolicyCUDResponse deepCopy() {
    return new TPaymentPolicyCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPaymentPolicyCUDResponse)
      return this.equals((TPaymentPolicyCUDResponse)that);
    return false;
  }

  public boolean equals(TPaymentPolicyCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPaymentPolicyCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPaymentPolicyCUDResponse(");
    boolean first = true;
  ...
  private static class TPaymentPolicyCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPaymentPolicyCUDResponseStandardScheme getScheme() {
      return new TPaymentPolicyCUDResponseStandardScheme();
    }
  }

  private static class TPaymentPolicyCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPaymentPolicyCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPaymentPolicyCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map330.size);
                ...
                for (int _i333 = 0; _i333 < _map330.size; ++_i333)
                {
                  ...
                  struct.errorList.put(_key331, _val332);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPaymentPolicyCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter334 : struct.errorList.entrySet())
          {
  ...
  private static class TPaymentPolicyCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPaymentPolicyCUDResponseTupleScheme getScheme() {
      return new TPaymentPolicyCUDResponseTupleScheme();
    }
  }

  private static class TPaymentPolicyCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPaymentPolicyCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPaymentPolicyCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter335 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPaymentPolicyCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map336.size);
          ...
          for (int _i339 = 0; _i339 < _map336.size; ++_i339)
          {
            ...
            struct.errorList.put(_key337, _val338);
          }
        }
        struct.setErrorListIsSet(true);
      }
