...
public class TRestrictionCUDResponse implements org.apache.thrift.TBase<TRestrictionCUDResponse, TRestrictionCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TRestrictionCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TRestrictionCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TRestrictionCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TRestrictionCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TRestrictionCUDResponse.class, metaDataMap);
  }

  public TRestrictionCUDResponse() {
  }
   ...
   */
  public TRestrictionCUDResponse(TRestrictionCUDResponse other) {
  ...
  public TRestrictionCUDResponse deepCopy() {
    return new TRestrictionCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TRestrictionCUDResponse)
      return this.equals((TRestrictionCUDResponse)that);
    return false;
  }

  public boolean equals(TRestrictionCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TRestrictionCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TRestrictionCUDResponse(");
    boolean first = true;
  ...
  private static class TRestrictionCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRestrictionCUDResponseStandardScheme getScheme() {
      return new TRestrictionCUDResponseStandardScheme();
    }
  }

  private static class TRestrictionCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TRestrictionCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TRestrictionCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map150.size);
                ...
                for (int _i153 = 0; _i153 < _map150.size; ++_i153)
                {
                  ...
                  struct.errorList.put(_key151, _val152);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRestrictionCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter154 : struct.errorList.entrySet())
          {
  ...
  private static class TRestrictionCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRestrictionCUDResponseTupleScheme getScheme() {
      return new TRestrictionCUDResponseTupleScheme();
    }
  }

  private static class TRestrictionCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRestrictionCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TRestrictionCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter155 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TRestrictionCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map156.size);
          java.lang.String _key157;
          java.lang.String _val158;
          for (int _i159 = 0; _i159 < _map156.size; ++_i159)
          {
            _key157 = iprot.readString();
            _val158 = iprot.readString();
            struct.errorList.put(_key157, _val158);
          }
        }
        struct.setErrorListIsSet(true);
      }
