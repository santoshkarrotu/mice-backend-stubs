...
public class TPackageDurationCUDResponse implements org.apache.thrift.TBase<TPackageDurationCUDResponse, TPackageDurationCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TPackageDurationCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPackageDurationCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPackageDurationCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPackageDurationCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPackageDurationCUDResponse.class, metaDataMap);
  }

  public TPackageDurationCUDResponse() {
  }
   ...
   */
  public TPackageDurationCUDResponse(TPackageDurationCUDResponse other) {
  ...
  public TPackageDurationCUDResponse deepCopy() {
    return new TPackageDurationCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPackageDurationCUDResponse)
      return this.equals((TPackageDurationCUDResponse)that);
    return false;
  }

  public boolean equals(TPackageDurationCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPackageDurationCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPackageDurationCUDResponse(");
    boolean first = true;
  ...
  private static class TPackageDurationCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPackageDurationCUDResponseStandardScheme getScheme() {
      return new TPackageDurationCUDResponseStandardScheme();
    }
  }

  private static class TPackageDurationCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPackageDurationCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPackageDurationCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map60.size);
                ...
                for (int _i63 = 0; _i63 < _map60.size; ++_i63)
                {
                  ...
                  struct.errorList.put(_key61, _val62);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPackageDurationCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter64 : struct.errorList.entrySet())
          {
  ...
  private static class TPackageDurationCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPackageDurationCUDResponseTupleScheme getScheme() {
      return new TPackageDurationCUDResponseTupleScheme();
    }
  }

  private static class TPackageDurationCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPackageDurationCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPackageDurationCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter65 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPackageDurationCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map66.size);
          ...
          for (int _i69 = 0; _i69 < _map66.size; ++_i69)
          {
            ...
            struct.errorList.put(_key67, _val68);
          }
        }
        struct.setErrorListIsSet(true);
      }
