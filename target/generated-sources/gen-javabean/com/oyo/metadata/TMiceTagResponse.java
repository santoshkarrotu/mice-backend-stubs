...
public class TMiceTagResponse implements org.apache.thrift.TBase<TMiceTagResponse, TMiceTagResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TMiceTagResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TMiceTagResponse");

  private static final org.apache.thrift.protocol.TField MICE_TAG_FIELD_DESC = new org.apache.thrift.protocol.TField("miceTag", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TMiceTagResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TMiceTagResponseTupleSchemeFactory();

  private TMiceTag miceTag; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.MICE_TAG, new org.apache.thrift.meta_data.FieldMetaData("miceTag", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TMiceTag.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TMiceTagResponse.class, metaDataMap);
  }

  public TMiceTagResponse() {
  }
   ...
   */
  public TMiceTagResponse(TMiceTagResponse other) {
    if (other.isSetMiceTag()) {
      this.miceTag = new TMiceTag(other.miceTag);
    }
  ...
  public TMiceTagResponse deepCopy() {
    return new TMiceTagResponse(this);
  }
  ...
  public TMiceTag getMiceTag() {
    return this.miceTag;
  }

  public void setMiceTag(TMiceTag miceTag) {
    this.miceTag = miceTag;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TMiceTagResponse)
      return this.equals((TMiceTagResponse)that);
    return false;
  }

  public boolean equals(TMiceTagResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TMiceTagResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TMiceTagResponse(");
    boolean first = true;
  ...
  private static class TMiceTagResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TMiceTagResponseStandardScheme getScheme() {
      return new TMiceTagResponseStandardScheme();
    }
  }

  private static class TMiceTagResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TMiceTagResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TMiceTagResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // MICE_TAG
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.miceTag = new TMiceTag();
              struct.miceTag.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map240.size);
                ...
                for (int _i243 = 0; _i243 < _map240.size; ++_i243)
                {
                  ...
                  struct.errorList.put(_key241, _val242);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMiceTagResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.miceTag != null) {
        oprot.writeFieldBegin(MICE_TAG_FIELD_DESC);
        struct.miceTag.write(oprot);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter244 : struct.errorList.entrySet())
          {
  ...
  private static class TMiceTagResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TMiceTagResponseTupleScheme getScheme() {
      return new TMiceTagResponseTupleScheme();
    }
  }

  private static class TMiceTagResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMiceTagResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TMiceTagResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter245 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TMiceTagResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map246.size);
          ...
          for (int _i249 = 0; _i249 < _map246.size; ++_i249)
          {
            ...
            struct.errorList.put(_key247, _val248);
          }
        }
        struct.setErrorListIsSet(true);
      }
