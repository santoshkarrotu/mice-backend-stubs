            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map190.size);
                ...
                for (int _i193 = 0; _i193 < _map190.size; ++_i193)
                {
                  ...
                  struct.errorList.put(_key191, _val192);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, THotelCategoryCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter194 : struct.errorList.entrySet())
          {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter195 : struct.errorList.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map196.size);
          ...
          for (int _i199 = 0; _i199 < _map196.size; ++_i199)
          {
            ...
            struct.errorList.put(_key197, _val198);
          }
        }
        struct.setErrorListIsSet(true);
      }
