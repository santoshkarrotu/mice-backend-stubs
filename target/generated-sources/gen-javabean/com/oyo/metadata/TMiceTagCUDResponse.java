...
public class TMiceTagCUDResponse implements org.apache.thrift.TBase<TMiceTagCUDResponse, TMiceTagCUDResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TMiceTagCUDResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TMiceTagCUDResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TMiceTagCUDResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TMiceTagCUDResponseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TMiceTagCUDResponse.class, metaDataMap);
  }

  public TMiceTagCUDResponse() {
  }
   ...
   */
  public TMiceTagCUDResponse(TMiceTagCUDResponse other) {
  ...
  public TMiceTagCUDResponse deepCopy() {
    return new TMiceTagCUDResponse(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TMiceTagCUDResponse)
      return this.equals((TMiceTagCUDResponse)that);
    return false;
  }

  public boolean equals(TMiceTagCUDResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TMiceTagCUDResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TMiceTagCUDResponse(");
    boolean first = true;
  ...
  private static class TMiceTagCUDResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TMiceTagCUDResponseStandardScheme getScheme() {
      return new TMiceTagCUDResponseStandardScheme();
    }
  }

  private static class TMiceTagCUDResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TMiceTagCUDResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TMiceTagCUDResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map250.size);
                ...
                for (int _i253 = 0; _i253 < _map250.size; ++_i253)
                {
                  ...
                  struct.errorList.put(_key251, _val252);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMiceTagCUDResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter254 : struct.errorList.entrySet())
          {
  ...
  private static class TMiceTagCUDResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TMiceTagCUDResponseTupleScheme getScheme() {
      return new TMiceTagCUDResponseTupleScheme();
    }
  }

  private static class TMiceTagCUDResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMiceTagCUDResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TMiceTagCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter255 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TMiceTagCUDResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map256.size);
          ...
          for (int _i259 = 0; _i259 < _map256.size; ++_i259)
          {
            ...
            struct.errorList.put(_key257, _val258);
          }
        }
        struct.setErrorListIsSet(true);
      }
