...
public class TPropertyWithCompleteDetails implements org.apache.thrift.TBase<TPropertyWithCompleteDetails, TPropertyWithCompleteDetails._Fields>, java.io.Serializable, Cloneable, Comparable<TPropertyWithCompleteDetails> {
  ...
  private static final org.apache.thrift.protocol.TField SERVICES_FIELD_DESC = new org.apache.thrift.protocol.TField("services", org.apache.thrift.protocol.TType.LIST, (short)13);
  private static final org.apache.thrift.protocol.TField TAGS_FIELD_DESC = new org.apache.thrift.protocol.TField("tags", org.apache.thrift.protocol.TType.LIST, (short)14);
  ...
  private java.util.List<TAmenitiesAvailable> amenities; // required
  private java.util.List<TServicesAvailable> services; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.AMENITIES, new org.apache.thrift.meta_data.FieldMetaData("amenities", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TAmenitiesAvailable.class))));
    tmpMap.put(_Fields.SERVICES, new org.apache.thrift.meta_data.FieldMetaData("services", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TServicesAvailable.class))));
  ...
  public TPropertyWithCompleteDetails(
    ...
    java.util.List<TAmenitiesAvailable> amenities,
    java.util.List<TServicesAvailable> services,
  ...
  public TPropertyWithCompleteDetails(TPropertyWithCompleteDetails other) {
    ...
    if (other.isSetAmenities()) {
      java.util.List<TAmenitiesAvailable> __this__amenities = new java.util.ArrayList<TAmenitiesAvailable>(other.amenities.size());
      for (TAmenitiesAvailable other_element : other.amenities) {
        __this__amenities.add(new TAmenitiesAvailable(other_element));
      }
      this.amenities = __this__amenities;
    }
    if (other.isSetServices()) {
      java.util.List<TServicesAvailable> __this__services = new java.util.ArrayList<TServicesAvailable>(other.services.size());
      for (TServicesAvailable other_element : other.services) {
        __this__services.add(new TServicesAvailable(other_element));
      }
  ...
  public java.util.Iterator<TAmenitiesAvailable> getAmenitiesIterator() {
    return (this.amenities == null) ? null : this.amenities.iterator();
  }

  public void addToAmenities(TAmenitiesAvailable elem) {
    if (this.amenities == null) {
      this.amenities = new java.util.ArrayList<TAmenitiesAvailable>();
    }
    this.amenities.add(elem);
  }

  public java.util.List<TAmenitiesAvailable> getAmenities() {
    return this.amenities;
  }

  public void setAmenities(java.util.List<TAmenitiesAvailable> amenities) {
    this.amenities = amenities;
  }
  ...
  public java.util.Iterator<TServicesAvailable> getServicesIterator() {
    return (this.services == null) ? null : this.services.iterator();
  }

  public void addToServices(TServicesAvailable elem) {
    if (this.services == null) {
      this.services = new java.util.ArrayList<TServicesAvailable>();
    }
    this.services.add(elem);
  }

  public java.util.List<TServicesAvailable> getServices() {
    return this.services;
  }

  public void setServices(java.util.List<TServicesAvailable> services) {
    this.services = services;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case AMENITIES:
      if (value == null) {
        ...
        setAmenities((java.util.List<TAmenitiesAvailable>)value);
      }
      break;
    ...
    case SERVICES:
      if (value == null) {
        ...
        setServices((java.util.List<TServicesAvailable>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.amenities = new java.util.ArrayList<TAmenitiesAvailable>(_list43.size);
                TAmenitiesAvailable _elem44;
                for (int _i45 = 0; _i45 < _list43.size; ++_i45)
                {
                  _elem44 = new TAmenitiesAvailable();
                  _elem44.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.services = new java.util.ArrayList<TServicesAvailable>(_list46.size);
                TServicesAvailable _elem47;
                for (int _i48 = 0; _i48 < _list46.size; ++_i48)
                {
                  _elem47 = new TServicesAvailable();
                  _elem47.read(iprot);
                  struct.services.add(_elem47);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tags = new java.util.ArrayList<java.lang.String>(_list49.size);
                java.lang.String _elem50;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPropertyWithCompleteDetails struct) throws org.apache.thrift.TException {
      ...
      if (struct.foodPackageList != null) {
        oprot.writeFieldBegin(FOOD_PACKAGE_LIST_FIELD_DESC);
        {
          ...
          for (TFoodPackage _iter52 : struct.foodPackageList)
          {
            _iter52.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.amenities != null) {
        oprot.writeFieldBegin(AMENITIES_FIELD_DESC);
        {
          ...
          for (TAmenitiesAvailable _iter53 : struct.amenities)
          {
            _iter53.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.services != null) {
        oprot.writeFieldBegin(SERVICES_FIELD_DESC);
        {
          ...
          for (TServicesAvailable _iter54 : struct.services)
          {
            _iter54.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.tags != null) {
        oprot.writeFieldBegin(TAGS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter55 : struct.tags)
          {
      ...
      if (struct.isSetFoodPackageList()) {
        {
          ...
          for (TFoodPackage _iter56 : struct.foodPackageList)
          {
            _iter56.write(oprot);
          }
        }
      ...
      if (struct.isSetAmenities()) {
        {
          ...
          for (TAmenitiesAvailable _iter57 : struct.amenities)
          {
            _iter57.write(oprot);
          }
        }
      ...
      if (struct.isSetServices()) {
        {
          ...
          for (TServicesAvailable _iter58 : struct.services)
          {
            _iter58.write(oprot);
          }
        }
      ...
      if (struct.isSetTags()) {
        {
          ...
          for (java.lang.String _iter59 : struct.tags)
          {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.foodPackageList = new java.util.ArrayList<TFoodPackage>(_list60.size);
          TFoodPackage _elem61;
          for (int _i62 = 0; _i62 < _list60.size; ++_i62)
          {
            _elem61 = new TFoodPackage();
            _elem61.read(iprot);
            struct.foodPackageList.add(_elem61);
          }
        }
        struct.setFoodPackageListIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.amenities = new java.util.ArrayList<TAmenitiesAvailable>(_list63.size);
          TAmenitiesAvailable _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = new TAmenitiesAvailable();
            _elem64.read(iprot);
            struct.amenities.add(_elem64);
          }
        }
        struct.setAmenitiesIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct.services = new java.util.ArrayList<TServicesAvailable>(_list66.size);
          TServicesAvailable _elem67;
          for (int _i68 = 0; _i68 < _list66.size; ++_i68)
          {
            _elem67 = new TServicesAvailable();
            _elem67.read(iprot);
            struct.services.add(_elem67);
          }
        }
        struct.setServicesIsSet(true);
      }
      if (incoming.get(13)) {
        {
          ...
          struct.tags = new java.util.ArrayList<java.lang.String>(_list69.size);
          java.lang.String _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = iprot.readString();
            struct.tags.add(_elem70);
          }
        }
        struct.setTagsIsSet(true);
      }
