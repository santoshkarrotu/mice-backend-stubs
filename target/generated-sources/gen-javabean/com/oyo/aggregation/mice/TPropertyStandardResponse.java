...
public class TPropertyStandardResponse implements org.apache.thrift.TBase<TPropertyStandardResponse, TPropertyStandardResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TPropertyStandardResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPropertyStandardResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPropertyStandardResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPropertyStandardResponseTupleSchemeFactory();

  private TPropertyWithStandardDetails propertyDetails; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.PROPERTY_DETAILS, new org.apache.thrift.meta_data.FieldMetaData("propertyDetails", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TPropertyWithStandardDetails.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPropertyStandardResponse.class, metaDataMap);
  }

  public TPropertyStandardResponse() {
  }

  public TPropertyStandardResponse(
    TPropertyWithStandardDetails propertyDetails,
    TStatus status,
   ...
   */
  public TPropertyStandardResponse(TPropertyStandardResponse other) {
    if (other.isSetPropertyDetails()) {
      this.propertyDetails = new TPropertyWithStandardDetails(other.propertyDetails);
    }
  ...
  public TPropertyStandardResponse deepCopy() {
    return new TPropertyStandardResponse(this);
  }
  ...
  public TPropertyWithStandardDetails getPropertyDetails() {
    return this.propertyDetails;
  }

  public void setPropertyDetails(TPropertyWithStandardDetails propertyDetails) {
    this.propertyDetails = propertyDetails;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PROPERTY_DETAILS:
      if (value == null) {
        ...
        setPropertyDetails((TPropertyWithStandardDetails)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPropertyStandardResponse)
      return this.equals((TPropertyStandardResponse)that);
    return false;
  }

  public boolean equals(TPropertyStandardResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPropertyStandardResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPropertyStandardResponse(");
    boolean first = true;
  ...
  private static class TPropertyStandardResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPropertyStandardResponseStandardScheme getScheme() {
      return new TPropertyStandardResponseStandardScheme();
    }
  }

  private static class TPropertyStandardResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPropertyStandardResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPropertyStandardResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // PROPERTY_DETAILS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.propertyDetails = new TPropertyWithStandardDetails();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map82.size);
                ...
                for (int _i85 = 0; _i85 < _map82.size; ++_i85)
                {
                  ...
                  struct.errorList.put(_key83, _val84);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPropertyStandardResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.errorList != null) {
        oprot.writeFieldBegin(ERROR_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter86 : struct.errorList.entrySet())
          {
  ...
  private static class TPropertyStandardResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPropertyStandardResponseTupleScheme getScheme() {
      return new TPropertyStandardResponseTupleScheme();
    }
  }

  private static class TPropertyStandardResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPropertyStandardResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPropertyStandardResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetErrorList()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter87 : struct.errorList.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPropertyStandardResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errorList = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map88.size);
          ...
          for (int _i91 = 0; _i91 < _map88.size; ++_i91)
          {
            ...
            struct.errorList.put(_key89, _val90);
          }
        }
        struct.setErrorListIsSet(true);
      }
