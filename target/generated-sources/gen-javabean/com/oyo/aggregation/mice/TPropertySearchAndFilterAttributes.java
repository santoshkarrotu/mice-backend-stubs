            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.priceRanges = new java.util.ArrayList<java.lang.String>(_list110.size);
                java.lang.String _elem111;
                for (int _i112 = 0; _i112 < _list110.size; ++_i112)
                {
                  _elem111 = iprot.readString();
                  struct.priceRanges.add(_elem111);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPropertySearchAndFilterAttributes struct) throws org.apache.thrift.TException {
      ...
      if (struct.priceRanges != null) {
        oprot.writeFieldBegin(PRICE_RANGES_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter113 : struct.priceRanges)
          {
      ...
      if (struct.isSetPriceRanges()) {
        {
          ...
          for (java.lang.String _iter114 : struct.priceRanges)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.priceRanges = new java.util.ArrayList<java.lang.String>(_list115.size);
          java.lang.String _elem116;
          for (int _i117 = 0; _i117 < _list115.size; ++_i117)
          {
            _elem116 = iprot.readString();
            struct.priceRanges.add(_elem116);
          }
        }
        struct.setPriceRangesIsSet(true);
      }
