...
public class TPropertyDetailedResponse implements org.apache.thrift.TBase<TPropertyDetailedResponse, TPropertyDetailedResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TPropertyDetailedResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPropertyDetailedResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPropertyDetailedResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPropertyDetailedResponseTupleSchemeFactory();

  private TPropertyWithCompleteDetails propertyDetails; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.PROPERTY_DETAILS, new org.apache.thrift.meta_data.FieldMetaData("propertyDetails", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TPropertyWithCompleteDetails.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPropertyDetailedResponse.class, metaDataMap);
  }

  public TPropertyDetailedResponse() {
  }

  public TPropertyDetailedResponse(
    TPropertyWithCompleteDetails propertyDetails,
    TStatus status,
   ...
   */
  public TPropertyDetailedResponse(TPropertyDetailedResponse other) {
    if (other.isSetPropertyDetails()) {
      this.propertyDetails = new TPropertyWithCompleteDetails(other.propertyDetails);
    }
  ...
  public TPropertyDetailedResponse deepCopy() {
    return new TPropertyDetailedResponse(this);
  }
  ...
  public TPropertyWithCompleteDetails getPropertyDetails() {
    return this.propertyDetails;
  }

  public void setPropertyDetails(TPropertyWithCompleteDetails propertyDetails) {
    this.propertyDetails = propertyDetails;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PROPERTY_DETAILS:
      if (value == null) {
        ...
        setPropertyDetails((TPropertyWithCompleteDetails)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPropertyDetailedResponse)
      return this.equals((TPropertyDetailedResponse)that);
    return false;
  }

  public boolean equals(TPropertyDetailedResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPropertyDetailedResponse other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPropertyDetailedResponse(");
    boolean first = true;
  ...
  private static class TPropertyDetailedResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPropertyDetailedResponseStandardScheme getScheme() {
      return new TPropertyDetailedResponseStandardScheme();
    }
  }

  private static class TPropertyDetailedResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPropertyDetailedResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPropertyDetailedResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // PROPERTY_DETAILS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.propertyDetails = new TPropertyWithCompleteDetails();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPropertyDetailedResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TPropertyDetailedResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPropertyDetailedResponseTupleScheme getScheme() {
      return new TPropertyDetailedResponseTupleScheme();
    }
  }

  private static class TPropertyDetailedResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPropertyDetailedResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPropertyDetailedResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPropertyDetailedResponse struct) throws org.apache.thrift.TException {
